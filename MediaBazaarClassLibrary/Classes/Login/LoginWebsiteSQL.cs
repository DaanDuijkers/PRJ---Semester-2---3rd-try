...
{
    public class LoginWebsiteSQL : GlobalDBMediator, ILogin
    {
        public LoginWebsiteSQL() { }

        public Employee Login(Employee employee)
        {
            Employee account = null;

            string sqlStatement = "SELECT * FROM Employee LEFT JOIN position ON employee.PositionID = position.ID WHERE UserName = @UserName AND Password = @Password;";
